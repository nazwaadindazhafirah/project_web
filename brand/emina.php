...
$produk = mysqli_query($conn, "SELECT * FROM produk WHERE brand = 'Emina'");
?>
<!DOCTYPE html>
<html>
<head>
    <title>Emina - Nazwaazhf Skincare</title>
...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../assets/gambar/emina/<?= $row['gambar'] ?>" class="produk-img card-img-top" alt="<?= $row['nama_produk'] ?>">
                <div class="card-body">

...
$produk = mysqli_query($conn, "SELECT * FROM produk WHERE brand = 'Scarlett'");
?>
<!DOCTYPE html>
<html>
<head>
    <title>Scarlett - Nazwaazhf Skincare</title>
...
<div class="container mt-4">
    ...
    <h2>Produk Scarlett</h2>
    <div class="row">
        <?php while ($row = mysqli_fetch_assoc($produk)): ?>
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../assets/gambar/scarlett/<?= $row['gambar'] ?>" class="produk-img card-img-top" alt="<?= $row['nama_produk'] ?>">
                <div class="card-body">
